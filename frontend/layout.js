...
function renderLayout(activePage) {
  ...
  const NAV = {
    owner: [
      ...
      { href: 'config.html',         icon: '⚙', label: 'Configuration'   },
      { href: 'audit.html',          icon: '⊟', label: 'Audit Log'       },
      { href: 'backup.html',         icon: '💾', label: 'Database Backup' },
    ],
    admin: [
    ...
    <div class="app">
      <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-footer">
          ...
          <a href="change-password.html" style="display:block;text-align:center;color:rgba(255,255,255,.45);font-size:.75rem;margin-bottom:.5rem;text-decoration:none;">🔐 Change Password</a>
